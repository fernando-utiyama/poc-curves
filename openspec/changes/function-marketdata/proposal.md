...
- **Novo serviço**: `services/function-marketdata/` em Node.js 20 + TypeScript, com `package.json`, build para container e handler de Azure Function.
...
- **Dados versionados**: fixtures de resposta da B3 entram no repositório em `services/function-marketdata/test/fixtures/`.
