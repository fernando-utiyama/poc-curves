...
Esta é a mudança **guarda-chuva**: ela fixa a topologia, os contratos de evento, o modelo de dados canônico e o runtime local em Podman. As outras sete mudanças (`function-marketdata`, `curve-processor`, `curve-engine`, `curve-orchestrator`, `curve-api`, `curve-bff`, `curve-web-ui`) implementam contra os contratos definidos aqui.
