...
- [x] 1.1 Criar `services/feeder-marketdata/` com Node 20, TypeScript estrito, `package.json` e scripts de build/test
...
- [x] 7.3 Documentar em `services/feeder-marketdata/README.md` os datasets, os parâmetros e como rodar isolado
...
`feeder-b3-marketdata`, renomeado para `feeder-marketdata` — pacote,
...
curve-engine) — esta seção implementa a QUARTA fonte do feeder-marketdata (Banco Central do
