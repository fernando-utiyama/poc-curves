...
import com.poccurves.orchestrator.application.model.CalendarioPregao;
...
import com.poccurves.orchestrator.application.service.AquisicaoExecutionService.ExecutionResult;
...
class DisparoAgendadoExecutorTest {
    ...
    void diaSemPregaoNaoCriaExecucao() {
        ...
        try (var mockedCalendario = mockStatic(com.poccurves.orchestrator.application.model.CalendarioPregao.class)) {
            mockedCalendario.when(() -> com.poccurves.orchestrator.application.model.CalendarioPregao.ehDiaDePregao(any())).thenReturn(false);
